...
function Partners() {
    return (
        <section className='bg-white p-5 flex flex-col items-center justify-center'>
            ...
            <div className='flex items-center mt-10 w-full justify-center'>
                <div className="w-[180px] h-[30px] lg:h-[50px] relative">
                    <Image fill className='' src={"/partners/partner-1.png"} alt='brand' />
                </div>
                <div className="w-[180px] h-[30px] lg:h-[50px] relative mx-10">
